...
.history-phone .card .circle {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 75px;
    height: 75px;
    border: 4px solid #D200BB;
    border-radius: 50%;
    position: absolute;
    left: 0;
    top: 50%;
